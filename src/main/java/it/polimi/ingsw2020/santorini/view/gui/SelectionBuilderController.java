...
public class SelectionBuilderController {
     ...
     * @param actionEvent is the event generated by the click on the buttons
     */
    @FXML
    ...
    /**
     * the method is called by setPos. The method set, invoking the method setBuilder, the builder in cell where the player clicked on.
     * @param builder is the reference to the array that contains the coordinates of the builder that has to be set by the method.
     * @param pos is the button corresponding to the cell where the builder will be set on. It is used to recognize which cell teh player
     * clicked on and therefore its coordinates.
     * @param gender is the gender of the builder that has to be set in on the cell
     * @param username is the string containing the username of the player
     */
    ...
    /**
     * the method sets the builder's coordinates equals to row and col(column of the cell). It then sets the label of the cell with the symbol
     * that represents the gender of the builder that is set on the cell.
     * @param builder is the reference to the array that contains the coordinates of the builder
     * @param row is the row of the cell
     * @param col is the column of the cell
     * @param username is string containing the username of the player
     * @param gender is the gender of the builder that has to be set on the cell
     * @param label is the label that will show the builder's gender
     */
