...
public class PrometheusTest {
    ...
    private PrometheusParamMessage godParamMessage;
    ...
    public void setUp() throws Exception {
        ...
        player1.setDivinePower(new Prometheus());
        player2.setDivinePower(new Pan());
        turnLogic = controller.getTurnManager();
        turnLogic.setStartTurn();
        message = new Message("Dog");
        godParamMessage = new PrometheusParamMessage();
        godParamMessage.setBuilderSex(player1.getBuilderF().getGender());
