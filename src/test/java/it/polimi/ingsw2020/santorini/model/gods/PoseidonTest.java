...
public class PoseidonTest {
    ...
    private PoseidonParamMessage godParamMessage;
    ...
    public void setUp() throws Exception {
        ...
        player1.setDivinePower(new Poseidon());
        player2.setDivinePower(new Pan());
        turnLogic = controller.getTurnManager();
        turnLogic.setStartTurn();
        message = new Message("Dog");
        godParamMessage = new PoseidonParamMessage();
        godParamMessage.setNumberOfBuild(1);
        godParamMessage.setConstructionGender('F');
        ArrayList<Direction> direction = new ArrayList<Direction>();
        direction.add(Direction.NORTH_WEST);
