...
public class AresTest {
    ...
    private AresParamMessage godParamMessage;
    ...
    public void setUp() throws Exception {
        ...
        player1.setDivinePower(new Ares());
        player2.setDivinePower(new Pan());
        turnLogic = controller.getTurnManager();
        turnLogic.setStartTurn();
        message = new Message("Dog");
        godParamMessage = new AresParamMessage();
        godParamMessage.setDemolitionBuilderSex(player1.getBuilderF().getGender());
        godParamMessage.setTargetedBlock(Direction.NORTH_WEST);
